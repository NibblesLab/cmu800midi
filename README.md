...
またオリジナルに対する追加機能として、コントロールチェンジの#019(General Purpose Controller 4)にチューニング用トーンの発生機能を割り当てました。チャンネルは関係なく、0以外の値をセットするとトーンが発生し、0をセットすると止まります。トーンを発生させてCMU-800本体のTUNEのキャップの中にあるトリマーをドライバーで回し、440Hzに合わせて下さい。
